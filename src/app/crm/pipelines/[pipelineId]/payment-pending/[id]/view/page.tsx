...
const NotFound = () => {
    ...
    return (
        <div className="text-center p-10">
            ...
            <button onClick={() => router.push(`/crm/pipelines/${pipelineId}/payment-pending`)} className="px-6 py-2 text-white bg-green-600 rounded-lg hover:bg-green-700">Return to List</button>
        </div>
    );
};
        ...
        <div className="min-h-screen p-4 sm:p-8 bg-gray-50">
            <div className="max-w-4xl mx-auto">
                <header className="flex flex-wrap justify-between items-center gap-4 mb-8">
                    ...
                    <button onClick={() => router.push(`/crm/pipelines/${pipelineId}/payment-pending`)} className="px-5 py-2 text-white font-semibold bg-green-600 rounded-lg hover:bg-green-700">Back to List</button>
                </header>
